...
export const Favourites = () => {
    ...
    useEffect(() => {
        setBadges({...badges, fav: false})
        localStorage.setItem("badges", JSON.stringify({...badges, fav: false}))
    }, [])
    ...
    const handleDeleteFromFav = (_id, index) => {
        setLoading(index)
        axios({
            method: "delete",
            url: `${API}/items/favourite`,
                            ...
                            <div className="img-content">
                                ...
                                <div className="delete-button">
                                    <IconButton 
                                        color="secondary"
                                        aria-label="delete" 
                                        onClick={() => handleDeleteFromFav(_id, index)} 
                                    >
                                        {loading === index 
